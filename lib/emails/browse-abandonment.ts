      ...
      <div style="font-family:'Helvetica Neue',Arial,sans-serif;max-width:600px;margin:0 auto;background:#FAF7F2;">
        ...
        <div style="padding:40px 32px;">
          ...
          <div style="background:#fff;border:1px solid #E5E0D8;border-radius:12px;padding:20px;text-align:center;">
            ...
            <p style="margin:0 0 10px;font-size:17px;font-weight:700;color:#2D4A3E;">Framed prints ship in 5–7 days</p>
            <p style="margin:0;color:#666;font-size:13px;">The perfect gift — gallery-quality 8×10 framed print delivered to your door.</p>
          </div>
        </div>
