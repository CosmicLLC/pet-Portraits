...
<p>Brushwork is varied and visible. Fur is built up in directional strokes that follow the actual growth of the coat. Highlights on the eye, nose, and whisker pads use thicker impasto-style paint that catches light differently from the surrounding canvas. Edges range from sharp at the focal points of the face to softer at the periphery, pulling the viewer's eye exactly where a trained portraitist would put it. The palette favors warm earth tones — raw sienna, burnt umber, ivory black, lead white, rose madder — over modern bright pigments. Color saturation is rich but never neon, and the surface texture is preserved so the finished portrait reads as paint on a surface rather than a digital image of paint.</p>`,
...
<p>Upload a clear photo, get a preview in roughly thirty seconds, and only pay if the portrait holds up. Digital download is $6, museum-grade fine-art prints start at $16, and a framed print in a deep wood frame ships for $79 inside the United States. The work is AI-assisted, human-curated styles. That is the honest description.</p>`,
    ...
    faqs: [
      ...
      {
        q: "What does the framed print actually look and feel like?",
        a: "The framed print is a giclée fine-art print on heavyweight archival paper, framed behind glazing in a solid wood moulding — deep walnut or black depending on the portrait's tonal balance — with a clean mat around the image. It arrives ready to hang with hardware attached. The matte archival surface suits the oil style: it reads as a painted artwork rather than a glossy photograph. The standard size is 8×10, with 12×16 and 18×24 available at additional cost.",
      },
      {
        q: "Will the brushwork look real up close?",
        a: "Up close, the portrait reads as a high-resolution rendering of oil paint rather than literal physical paint. Brushstroke direction, edge softness, and highlight thickness are all rendered into the image, and at the printed scale they hold up to normal viewing distance — a foot or two away. If you look closely you will see that it is a print, not a hand-painted original. We do not claim otherwise. Across a room, in a frame, the distinction disappears. That is what most people want from a pet portrait.",
      },
    ],
...
<p>Outputs that drift from the source photo on likeness, or that produce costume distortions inconsistent with the period reference set, are flagged by our automated review and sent for human curation. Around one in eight Renaissance portraits gets a manual pass — the highest review rate of any style we offer, because the costume layer is unforgiving. Upload a photo, see a preview in thirty seconds, pay $6 for digital or $79 for the framed print only if you love the result. AI-assisted, human-curated styles. That is the actual workflow, not a slogan.</p>`,
    ...
    faqs: [
      ...
      },
      {
        ...
        a: "The digital download is delivered at 4096 by 5120 pixels — large enough to print at 12×16 inches at 300 DPI without quality loss, and larger at acceptable resolution. The framed print standard size is 8×10 in a deep wood frame; 12×16 and 18×24 are available at additional cost. The Renaissance style holds up especially well at larger sizes because the costume detail rewards close looking, so if you have the wall for it, the bigger print is the better gift.",
      },
      {
...
<p>Line art is the most flexible style we offer when it comes to where it hangs. Modern apartments, Scandinavian interiors, mid-century homes, and minimalist white-on-white spaces are its natural home — the style was built for clean walls and uncluttered rooms. Frame it in a thin black or natural-oak frame with a generous white mat, hung on a white or warm-greige wall, and the portrait reads as deliberate restraint rather than absence. It pairs beautifully with other line drawings, black-and-white photography, simple geometric prints, and quiet ceramics. In a gallery wall, line art is the anchor piece that lets the busier pieces breathe. It also works unexpectedly well in transitional and traditional rooms as a counterweight to heavier decor — a single elegant line drawing of the family dog above a console table softens a formal entryway in a way a colorful piece would not. The style is hard to put in the wrong room.</p>`,
    ...
    process: `<h2>How we make it</h2>
<p>Each line art portrait is generated by an AI model trained on a tight corpus of minimalist portrait drawing — Picasso's single-line work, Matisse line drawings, contemporary tattoo flash, classical graphite studies — and constrained to produce clean vector-style output on pure white. The model receives your photograph and is instructed to abstract the form into the smallest number of lines that still preserves the pet's identifying features: ear set, eye shape and spacing, snout length, distinctive markings if present. Line weight varies deliberately — heavier on structural contours, lighter on internal modeling — and the output is rendered at high resolution so it prints crisply at any size from a 5x7 card to a 24×36 print.</p>
