# Evergreen Blog Drafts — 5 Posts

Drafted 2026-05-25. Paste each TypeScript object into the `BLOG_POSTS` array in `lib/blog-posts.ts`. Slugs verified non-colliding against existing entries (`last-minute-mothers-day-gifts-for-pet-moms`, `mothers-day-gifts-for-cat-moms`, `mothers-day-gift-for-pet-mom-grieving`, `best-mothers-day-gift-for-dog-mom`, `how-to-photograph-your-pet-for-a-custom-portrait`).

---

## Post 1 — Best Father's Day Gifts for Dog Dads (and Cat Dads Too)

- **Title:** Best Father's Day Gifts for Dog Dads (and Cat Dads Too)
- **Slug:** `best-fathers-day-gifts-for-dog-dads`
- **Word count (body):** ~1,920 words
- **Hero:** `/examples/oil.png`
...
## Post 2 — AI Pet Portraits vs Hand-Painted: An Honest Buyer's Guide

- **Title:** AI Pet Portraits vs Hand-Painted: An Honest Buyer's Guide
- **Slug:** `ai-pet-portraits-vs-hand-painted-buyers-guide`
- **Word count (body):** ~1,940 words
- **Hero:** `/examples/renaissance.png`
...
## Post 3 — How to Hang a Pet Portrait in Your Home (Decorator's Guide)

- **Title:** How to Hang a Pet Portrait in Your Home (Decorator's Guide)
- **Slug:** `how-to-hang-a-pet-portrait-in-your-home`
- **Word count (body):** ~1,640 words
- **Hero:** `/examples/watercolor.png`
...
## Post 4 — The Photo You Already Have Is Good Enough: A Pet Portrait Photo Guide

- **Title:** The Photo You Already Have Is Good Enough
- **Slug:** `the-photo-you-already-have-is-good-enough`
- **Word count (body):** ~1,600 words
- **Hero:** `/examples/lineart.png`
...
<p>iPhones from the last six or seven years take photos that are more than enough resolution for a portrait, even a large canvas. Android flagships, same. We don't need a DSLR. We don't need a professional photo session. We don't need RAW files.</p>
...
## Post 5 — Memorial Pet Portraits: A Gentle Guide for Grieving Pet Parents
...
| # | Slug | Title | Words | Hero |
|---|---|---|---|---|
| 1 | `best-fathers-day-gifts-for-dog-dads` | Best Father's Day Gifts for Dog Dads (and Cat Dads Too) | ~1,920 | oil.png |
| 2 | `ai-pet-portraits-vs-hand-painted-buyers-guide` | AI Pet Portraits vs Hand-Painted: An Honest Buyer's Guide | ~1,940 | renaissance.png |
| 3 | `how-to-hang-a-pet-portrait-in-your-home` | How to Hang a Pet Portrait in Your Home (Decorator's Guide) | ~1,640 | watercolor.png |
| 4 | `the-photo-you-already-have-is-good-enough` | The Photo You Already Have Is Good Enough | ~1,600 | lineart.png |
| 5 | `memorial-pet-portraits-gentle-guide-grieving-pet-parents` | Memorial Pet Portraits: A Gentle Guide for Grieving Pet Parents | ~1,920 | oil.png |

**Total body word count:** ~9,020 words

**Verifications performed:**
- All 5 slugs checked against existing entries in `lib/blog-posts.ts` — no collisions
- All internal links route to listed routes from the brief
- Memorial post: zero exclamation points, no "live forever" / "watch over you" / "be with you always" phrasing
- Father's Day post: evergreen framing ("coming up in about four weeks") — no hard-coded year
- No AI buzzwords ("game-changing", "revolutionary", "next-generation")
- TypeScript template literals use backticks; straight quotes inside body strings (matches existing file convention)
- Each post has 4+ internal links
- H2 headers spaced every 250–400 words
