# Pet Blogger Outreach — Paw Masterpiece

Drafts for 9 verified outlets. Personalize the bracketed line in each before sending. Send from cosmic.company.llc@gmail.com.

---

## 1. DogTipper.com — Paris Permenter

**To:** paris@dogtipper.com
...
**To:** advertising@moderndogmagazine.com
...
## 3. This Dog's Life — Andrea Huspeni

**To:** admin@thisdogslife.co
...
**Notes:** Sponsored review is the ask, affiliate is the optional second beat per the brief. Personalize with a specific gift guide or review she's written — her bylined posts are easy to find.

---

## 4. PetGuide.com

**To:** hello@petguideplus.com
...
**Notes:** Editorial-first ask, with the paid-placement option named so they don't have to fish for it. Personalize with a gift guide or roundup so they see the angle right away.

---

## 5. Rover Blog (The Dog People)

**To:** marketing-inquiries@rover.com
**Subject:** Co-marketing idea for The Dog People

**Body:**
Hi Rover marketing team,
...
## 6. Dogster.com (Pangolia)

**To:** Submitted via dogster.com/contact-us-now
...
**Notes:** Pure FYI + media kit ask, per the brief — they don't take editorial. Personalize with any section reference (Health, Lifestyle, etc.) so it doesn't read like a blast.

---

## 8. Fido Friendly

**To:** Per the media kit at fidofriendly.com/mediakit.pdf (use the contact listed there)
**Subject:** Sponsored editorial inquiry — Paw Masterpiece

**Body:**
Hi Fido Friendly team,
...
**Notes:** Treats the media kit as homework done — references their issue cadence rather than asking what they cover. Memorial portrait mention is honest (it's a real category for them, gentle tone). Personalize with an issue theme.

---

## 9. BlogPaws

**To:** Per blogpaws.com/events/write-for-us
